...
// Defina uma classe comparadora para comparar os nomes dos personagens
class NomePersonagemComparator implements Comparator<Q05TP2.personagem> {

  @Override
  public int compare(Q05TP2.personagem p1, Q05TP2.personagem p2) {
...
public class Q05TP2 {
  ...
  public static void main(String[] args) {
    ...
    List<personagem> nomesPersonagensFornecidos = new ArrayList<>();
    String entrada = sc.nextLine();
    while (!(entrada.equals("FIM"))) {
      for (personagem p : personagens) {
        if (p.getId().equals(entrada)) {
          nomesPersonagensFornecidos.add(p);
          break;
        }
      }
      entrada = sc.nextLine();
    ...
    Collections.sort(
      nomesPersonagensFornecidos,
      new NomePersonagemComparator()
    );

    for (personagem personagem : nomesPersonagensFornecidos) {
      System.out.println(personagem);
    }
  }
}
