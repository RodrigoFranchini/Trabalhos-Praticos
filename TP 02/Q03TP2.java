...
public class Q03TP2 {
  ...
  public static void encontrarNome(List<String> list, String nome) {
  ...
  public static void main(String[] args) {
    ...
    List<String> nomesPersonagensFornecidos = new ArrayList<>();
    String entrada = sc.nextLine();
    while (!(entrada.equals("FIM"))) {
      for (personagem p : personagens) {
        if (p.getId().equals(entrada)) {
          nomesPersonagensFornecidos.add(p.getName());
          break;
        }
      }
      entrada = sc.nextLine();
    ...
    while (!(nome.equals("FIM"))) {
      encontrarNome(nomesPersonagensFornecidos, nome);
      nome = sc.nextLine();
    }
  }
}
