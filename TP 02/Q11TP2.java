...
class PersonagemComparator implements Comparator<Q11TP2.personagem> {

  @Override
  public int compare(Q11TP2.personagem p1, Q11TP2.personagem p2) {
    // Comparar yearOfBirth
    int yearOfBirthComparison = p1
      .getYearOfBirth()
      .compareTo(p2.getYearOfBirth());

    // Se yearOfBirth for igual, comparar pelo nome
    if (yearOfBirthComparison == 0) {
      return p1.getName().compareToIgnoreCase(p2.getName());
    } else {
      return yearOfBirthComparison;
    }
  }
}
...
public class Q11TP2 {
  ...
  public static void main(String[] args) {
    ...
    Collections.sort(PersonagensFornecidos, new PersonagemComparator());
