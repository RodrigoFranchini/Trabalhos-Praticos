...
class hairColourComparator implements Comparator<Q09TP2.personagem> {

  @Override
  public int compare(Q09TP2.personagem p1, Q09TP2.personagem p2) {
    // Primeiro, comparar haircolour
    int hairColourComparison = p1
      .getHairColour()
      .compareToIgnoreCase(p2.getHairColour());

    // Se haircolour for o mesmo, comparar pelo nome
    if (hairColourComparison == 0) {
      return p1.getName().compareToIgnoreCase(p2.getName());
    } else {
      return hairColourComparison;
    }
  }
}
...
public class Q09TP2 {
  ...
  public static void main(String[] args) {
    ...
    Collections.sort(PersonagensFornecidos, new hairColourComparator());
