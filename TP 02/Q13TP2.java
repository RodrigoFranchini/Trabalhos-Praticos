...
class PersonagemComparator implements Comparator<Q13TP2.personagem> {

    @Override
    public int compare(Q13TP2.personagem p1, Q13TP2.personagem p2) {
      // Comparar actorName
      int actorNameComparison = p1.getActorName().compareTo(p2.getActorName());
      
      // Se actorName for igual, comparar pelo nome
      if (actorNameComparison == 0) {
          return p1.getName().compareToIgnoreCase(p2.getName());
      } else {
          return actorNameComparison;
      }
    }
  }
...
public class Q13TP2 {
  ...
  public static void main(String[] args) {
    ...
    Collections.sort(
      PersonagensFornecidos,
      new PersonagemComparator()
    );
